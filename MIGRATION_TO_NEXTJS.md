...
```env
NEXT_PUBLIC_API_URL=https://store-rebuild-3.preview.emergentagent.com/api
```
...
**Backend API URL:** https://store-rebuild-3.preview.emergentagent.com/api
**Current React app:** https://store-rebuild-3.preview.emergentagent.com
