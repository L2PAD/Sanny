      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="bg-white rounded-2xl shadow-sm p-8 mb-6">
          <p className="text-lg text-gray-700 mb-4">
            {language === 'ru'
              ? 'BAZAAR — это современный интернет-магазин, который предлагает широкий ассортимент качественных товаров по выгодным ценам.'
              : 'BAZAAR — це сучасний інтернет-магазин, який пропонує широкий асортимент якісних товарів за вигідними цінами.'}
          </p>
