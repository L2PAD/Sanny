        ...
        <div className="flex items-center justify-between py-4 gap-4">
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="flex items-center gap-2">
              <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="w-8 h-8 bg-black rounded-full flex items-center justify-center hover:bg-gray-800">
